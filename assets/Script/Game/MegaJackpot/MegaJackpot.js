...
cc.Class({
	...
	init: function(obj){
		this.RedT = obj;
		cc.RedT.setting.MegaJackpot = cc.RedT.setting.MegaJackpot || {scale:0.8333333, users:{100:0, 1000:0, 10000:0}};
	...
	setTop:function(){
		cc.RedT.setting.MegaJackpot.scale = 0.8333333;
	...
	openGame: function () {
		...
		if (cc.RedT.IS_LOGIN){
			...
			this.setTop();
			cc.RedT.listGame.push("MegaJackpot");
