...
var helper    = require('Helper'),
	reel      = require('DongMauAnhHung_reel'),
	Line      = require('DongMauAnhHung_lines'),
	gameBonus = require('DongMauAnhHung_playBonus'),
	notice    = require('Notice'),
	dialog    = require('DongMauAnhHung_dialog');
...
cc.Class({
	...
	onData: function(data) {
		...
		if (void 0 !== data.VuongQuocRed){
            this.TamHung(data.VuongQuocRed);
        }
		if (void 0 !== data.mini){
